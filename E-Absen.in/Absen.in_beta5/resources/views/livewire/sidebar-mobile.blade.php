...
<div x-data="{ isActive: false, open: false}">
  ...
  <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" aria-label="Authentication">
    ...
    <a href="{{ route('absenku') }}" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
      Absenku
    </a>
    <a href="{{ route('rekapabsenanggota') }}" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
      Rekap Absen Anggota
    </a>
    <a href="{{ route('jamkerja') }}" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
      Jam Kerja
    </a>
  </div>
</div>
