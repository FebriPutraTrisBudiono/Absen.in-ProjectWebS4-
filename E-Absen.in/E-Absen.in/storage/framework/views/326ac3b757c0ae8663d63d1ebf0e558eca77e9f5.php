...
<?php endif; ?>
                ...
                <div x-data="{ isActive: false, open: false }">
                  ...
                  <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.nav-link','data' => ['href' => ''.e(route('jabatan')).'','active' => request()->routeIs('jabatan')]]); ?>
<?php $component->withName('jet-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['href' => ''.e(route('jabatan')).'','active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('jabatan'))]); ?>
                    <span aria-hidden="true">
                      <svg
                        class="w-5 h-5"
                        xmlns="http://www.w3.org/2000/svg"
...
<?php endif; ?>
                ...
                </div><?php /**PATH C:\xampp\htdocs\Absen.in-ProjectWebS4\E-Absen.in\E-Absen.in\resources\views/livewire/sidebar-mobile.blade.php ENDPATH**/ ?>