...
<html lang="en">
  <head>
    ...
    <script src="<?php echo e(asset('js/jam.js')); ?>"></script>
  </head>
...
} elseif ($_instance->childHasBeenRendered('Up1l4JW')) {
    $componentId = $_instance->getRenderedChildComponentId('Up1l4JW');
    $componentTag = $_instance->getRenderedChildComponentTagName('Up1l4JW');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Up1l4JW');
} else {
    $response = \Livewire\Livewire::mount('sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('Up1l4JW', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </aside>
...
} elseif ($_instance->childHasBeenRendered('xSs7c5x')) {
    $componentId = $_instance->getRenderedChildComponentId('xSs7c5x');
    $componentTag = $_instance->getRenderedChildComponentTagName('xSs7c5x');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xSs7c5x');
} else {
    $response = \Livewire\Livewire::mount('header');
    $html = $response->html();
    $_instance->logRenderedChild('xSs7c5x', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
            ...
            >
              <nav aria-label="Main" class="px-2 py-4 space-y-2">
                ...
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('sidebar-mobile')->html();
} elseif ($_instance->childHasBeenRendered('DNHARon')) {
    $componentId = $_instance->getRenderedChildComponentId('DNHARon');
    $componentTag = $_instance->getRenderedChildComponentTagName('DNHARon');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('DNHARon');
} else {
    $response = \Livewire\Livewire::mount('sidebar-mobile');
    $html = $response->html();
    $_instance->logRenderedChild('DNHARon', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
              </nav>
...
<?php /**PATH C:\xampp\htdocs\Absen.in-ProjectWebS4\E-Absen.in\E-Absen.in\resources\views/layouts/app.blade.php ENDPATH**/ ?>